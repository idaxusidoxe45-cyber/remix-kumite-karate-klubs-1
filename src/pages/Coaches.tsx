  ...
  return (
    <div className="bg-[#ffffff] text-[#0f172a]">
      ...
      <section className="relative bg-[#0a0a0c] text-white py-20 lg:py-28 overflow-hidden border-b-8 border-[#dc2626]">
        <div className="absolute inset-0 bg-cover bg-center opacity-25 filter grayscale" style={{ backgroundImage: "url('/assets_coaches/marikanikolajs-52-scaled.webp')" }}></div>
